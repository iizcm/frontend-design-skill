...
[![Category: Frontend](https://img.shields.io/badge/Category-Frontend-purple)](#)
...
cp -r frontend-design ~/.hermes/skills/frontend-design/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/frontend-design-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/frontend-design-skill.git ~/.hermes/skills/frontend-design/
```
...
```text
Use the frontend design skill to <describe your specific task here>
```
...
```text
Gunakan skill frontend design untuk <deskripsikan tugas spesifik Anda di sini>
```
